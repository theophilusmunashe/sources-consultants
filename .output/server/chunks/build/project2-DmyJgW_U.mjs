import { _ as _sfc_main$5 } from './virtual_public-BFwKEG61.mjs';
import { _ as _sfc_main$1$1, a as _sfc_main$6 } from './Menu-PeBTF4l6.mjs';
...
import { _ as _sfc_main$7 } from './Footer1-C1sHJYFV.mjs';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section-padding bord-thin-bottom" }, _attrs))}><div class="container"><div class="row"><div class="col-lg-5"><h2 class="mb-50">The <br> Overview</h2></div><div class="col-lg-7"><div class="text"><h5 class="mb-30 fw-400 line-height-40">NBS Bank enlisted the expertise of Sources Consultants to revitalize its brand identity and enhance its market positioning. The objective was to develop a cohesive and compelling branding strategy that would resonate with existing customers, attract new clients, and reinforce NBS Bank&#39;s reputation as a leading financial institution in the region.</h5><p class="fz-18">Objective: To create a unified and recognizable brand identity for NBS Bank. To strengthen brand loyalty and customer trust. To differentiate NBS Bank from competitors through a unique value proposition. To enhance the bank\u2019s visibility and engagement across multiple channels.</p></div><div class="accordion bord mt-100"><!--[-->`);
...
//# sourceMappingURL=project2-DmyJgW_U.mjs.map
