...
const layouts = {
  default: () => import('./default-Bix_zWov.mjs').then((m) => m.default || m),
  preview: () => import('./preview-C9lCxmmW.mjs').then((m) => m.default || m)
};
